...
# project_ds_kedro documentation build
...
from project_ds_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "project_ds_kedro"
author = "Kedro"
...
htmlhelp_basename = "project_ds_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "project_ds_kedro.tex",
        "project_ds_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "project_ds_kedro",
        "Project project_ds_kedro codebase.",
        "Data-Science",
    )
]
